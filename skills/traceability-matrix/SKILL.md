...
description: Builds and validates the traceability chain across all SE artifacts — Raw Requirements → System Requirements → Design Elements → Test Cases. Identifies coverage gaps, orphaned design elements, and untested requirements. Use after completing any SE artifact, before milestone reviews, or when scope changes to assess impact.
---
